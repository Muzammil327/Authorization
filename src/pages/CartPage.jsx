...
// try {
//   const URL = `${import.meta.env.VITE_LOCALHOST}/api/product/upload`;
...
const URL = `${import.meta.env.VITE_LOCALHOST}/api/product/upload`; // Define your API endpoint URL
  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <input
        ...
        className="border border-gray-300 rounded p-2 w-48 text-center mb-4"
      />
